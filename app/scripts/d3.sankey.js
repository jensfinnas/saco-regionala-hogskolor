/* A slightly modified version of the original plugin
*/
...
d3.sankey = function() {
  ...
  function computeNodeDepths(iterations) {
    ...
    // Change to sort by id instead of value
  ...
  function computeLinkDepths() {
    ...
    nodes.forEach(function(node) {
      ...
      node.targetLinks.forEach(function(link) {
        ...
        ty += link.dy;
        // EDITED FROM ORIGINAL
        // Storing an aggregated ty varible allows us to place labels at vertical center
        link.tty = ty;
      });
    });
